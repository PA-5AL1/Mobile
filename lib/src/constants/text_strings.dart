const String tAppName = 'Croix Rouge Storage Manager';
const String tOrganizationName = 'Croix Rouge';
const String tOrganizationCity = 'Le Perreux-Sur-Marne';
...
const String tSignUpButton = 'S\'inscrire';
const String tDontHaveAnAccount = 'Vous n\'avez pas de compte ? ';
const String tAlreadyHaveAccount = 'Vous avez déjà un compte ? ';

const String tEmail = 'Email';
const String tEmailHint = 'Email@email.fr';

const String tPassword = 'Mot de passe';
const String tNewPassword = 'Nouveau mot de passe';
const String tReTypePasswordAgaon = 'Retaper votre mot de passe';
...
const String tOtpMessage = 'Veuillez entrer le code de vérification envoyé à ';

const String tEditProfile = 'Modifier le profil';
const String tLogout = 'Déconnexion';
...
const String tLightMode = 'Mode clair';
const String tDarkMode = 'Mode sombre';

const String tInfo = 'Info';
const String tUsersPanel = 'Panel utilisateur';

const tJoined = 'Inscrit le ';
const tJoinedAt = ' 31 juillet 2022';
